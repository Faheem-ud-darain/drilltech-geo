...
const TRANSLATIONS = {
  en: {
    ...
    op1Desc: "Operating custom truck-mounted rigs (Mobile Drill B57) deep within the golden deserts of Saudi Arabia, surveying structural feasibility for industrial corridors and mining claims.",
  ...
  ar: {
    ...
    op1Desc: "تشغيل الحفارات المحمولة على شاحنات المخصصة (Mobile Drill B57) في عمق الصحاري السعودية، لدراسة الجدوى الإنشائية للممرات الصناعية ومناجم التعدين.",
